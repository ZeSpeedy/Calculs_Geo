...
public class MoneyTest extends TestCase{
    ...
    /**
     * Question 5 : Ecrire une méthode test testCurrency()
     *
     *
    ...
    public void testAdd_Money() throws Exception {
        ...
        Money instance = new Money(180, "EUR");
        Money expResult = new Money(323, "EUR");
    ...
    public void testAdd() throws Exception {
        ...
        String currency = "EUR";
        Money instance = new Money(180, "EUR");
        Money expResult = new Money(190, "EUR");
    ...
    /**
     * Question 6 : écrire une méthode test testAdd() qui utilise la fonction add(int, String)
     *
     *
     * Test of add method, of class Money.
     *
